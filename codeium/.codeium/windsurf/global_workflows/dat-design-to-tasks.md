...
- After completing `@workflow superpowers-brainstorming` and creating a design doc
...
- Refine breakdown: `@workflow dat-refine-epic task-xyz`
- Start work: `bd ready`
```
...
If yes → Invoke `@workflow dat-refine-epic <epic-id>`
...
- User can refine dependencies in `@workflow dat-refine-epic`
...
2. Refine if needed: `@workflow dat-refine-epic <epic-id>`
3. Start implementation: `bd ready` → pick a task
4. Use `@workflow superpowers-writing-plans` for detailed implementation plans
