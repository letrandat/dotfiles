...
- After creating an epic with `@workflow dat-design-to-tasks`
...
- Start work: `bd ready`
- Create implementation plan: `@workflow superpowers-writing-plans`
```
...
3. Use `@workflow superpowers-writing-plans` for detailed plans
4. Use `@workflow superpowers-using-git-worktrees` for isolated work
